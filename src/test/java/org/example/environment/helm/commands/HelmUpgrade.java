...
public class HelmUpgrade extends HelmParentCommand implements ShellCommand {
    ...
    protected String buildCommand() {
        ...
        if (!CollectionUtils.isEmpty(valuesFiles))
    ...
    public static class Builder extends HelmParentCommandBuilder<Builder, HelmUpgrade, OptionalParam>
            implements MandatoryReleaseName, MandatoryChart, OptionalParam {

        public Builder() {
            super(HelmUpgrade.class);
        }
    ...
    public interface OptionalParam extends OptionalParentCommandParams<OptionalParam, HelmUpgrade>{
